...
export default function Nav(){
    return (
        <div className="flex flex-col justify-center items-center mt-auto min-w-screen">
            ...
            <CiShoppingCart size={90} className="text-black bg-white rounded-full fixed bottom-5 flex flex-col items-center"/>
            <p className="text-black text-6xl absoltue">10</p>
